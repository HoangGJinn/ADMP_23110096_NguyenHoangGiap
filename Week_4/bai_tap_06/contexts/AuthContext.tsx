...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const { user, isLoading, isProfileLoading, isAuthenticated, error } = useAppSelector((state) => state.auth);
  ...
  const updateProfileFn = async (data: UpdateProfileRequest) => {
    try {
      await dispatch(updateUserProfileApi(data)).unwrap();
    } catch (error: any) {
